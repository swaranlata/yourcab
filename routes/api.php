...
|
*/
Route::post('/besafe','UserApiController@besafe');
Route::get('/testing' , 'UserApiController@testing');
Route::get('/privacy' , 'UserApiController@privacy');
Route::get('/aboutapp' , 'UserApiController@aboutus');
...
Route::post('/forgot_password','UserApiController@forgotpassword');
...
Route::get('/getLastThreeLocation' , 'UserApiController@getLastThreeLocation');
...
Route::post('/deletetrip' , 'UserApiController@delete_trip');
