...
@section('content')
            ...
            <div class="col-md-4">
                <div class="banner-form">
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="{{url('login')}}">
                                <h3>Ride with {{Setting::get('site_title','Your Cab')}}</h3>
    ...
    <div class="row white-section no-margin">
        <div class="container">
            ...
            <div class="col-md-4 content-block small">
                ...
                <p>{{ Setting::get('site_title', 'Your Cab')  }} is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
            </div>

            <div class="col-md-4 content-block small">
                <h2>Choose how to pay</h2>
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With {{ Setting::get('site_title', 'Your Cab') }}, the choice is yours.</p>
            </div>
    ...
    <div class="row gray-section no-margin">
        <div class="container">                
            <div class="col-md-6 content-block">
                ...
                <div class="title-divider"></div>
                <p>Whether riding in the backseat or driving up front, every part of the {{ Setting::get('site_title', 'Your Cab') }} experience has been designed around your safety and security.</p>
    ...
    <div class="row find-city no-margin">
        <div class="container">
            <h2>{{Setting::get('site_title','Your Cab')}} is in Chennai</h2>
            <form>
