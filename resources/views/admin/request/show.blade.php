            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{ $request->distance ? number_format($request->distance,2) : '-' }}</dd>
...
<script type="text/javascript">
    var SITE='http://clientstagingdev.com/yourcab/public';
    var map;
    var zoomLevel = 11;
    ...
    function initMap() {
        ...
        var marker = new google.maps.Marker({
            map: map,
            icon: SITE+'/asset/img/provider_marker.png',            
            /*icon: SITE+'/asset/img/marker-start.png',*/
            anchorPoint: new google.maps.Point(0, -29)
        });

         var markerSecond = new google.maps.Marker({
            map: map,
            icon: SITE+'/asset/img/user_marker.png',
          /*  icon: SITE+'/asset/img/marker-end.png',*/
            anchorPoint: new google.maps.Point(0, -29)
        });
