    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.provider.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
					<label for="last_name" class="col-xs-12 col-form-label">License No.</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('license_no') }}" name="license_no" required id="license_no" placeholder="License No">
					</div>
				</div>
                <div class="form-group row">
					<label for="last_name" class="col-xs-12 col-form-label">Car Registration No.</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('car_registration_no') }}" name="car_registration_no" required id="car_registration_no" placeholder="Car Registration Number">
					</div>
				</div>
                <div class="form-group row">
					<label for="last_name" class="col-xs-12 col-form-label">Taxi No.</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('taxi_no') }}" name="taxi_no" required id="last_name" placeholder="Taxi Number">
					</div>
				</div>
                <div class="form-group row">
					<label for="last_name" class="col-xs-12 col-form-label">PSV No.</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('psv_no') }}" name="psv_no" required id="psv_no" placeholder="PSV No">
					</div>
				</div>
