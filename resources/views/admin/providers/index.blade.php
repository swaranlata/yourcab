...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <table class="table table-striped table-bordered dataTable table-responsive" id="table-2">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Full Name</th>
                ...
                @foreach($providers as $index => $provider)
                    <tr>
                        ...
                        @endif
                        <td>{{ $provider->license_no }}</td>
                        <td>{{ $provider->car_registration_no }}</td>
                        <td>{{ $provider->city}}</td>
                       <!-- <td>{{ $provider->taxi_no }}</td>
                        <td>{{ $provider->psv_no }}</td>-->
                            ...
                            <div class="input-group-btn">
                                ...
                                <ul class="dropdown-menu">
                                   <!-- <li>
                                    ...
                                    <li>
                                        <a href="{{ route('admin.provider.show', $provider->id) }}" class="btn btn-primary"><i class="fa fa-eye"></i> View</a>
                                    </li>  <li>
                                        <a href="{{ route('admin.provider.edit', $provider->id) }}" class="btn btn-default"><i class="fa fa-pencil"></i> Edit</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" data-id="<?php echo $provider->id; ?>" class="btn btn-default sendMessageToparticularDriver"><i class="fa fa-inbox"></i>&nbsp;Message</a>
                                    </li>
                                    <li>
