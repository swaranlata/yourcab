	...
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				...
				<ul>
					<li><a href="{{ route('admin.user.index') }}">List Passengers</a></li>
					<!--<li><a href="{{ route('admin.user.create') }}">Add New Passenger</a></li>-->
				</ul>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
            ...
            <li class="menu-title">Faq Management</li>
             <li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
					<span class="s-text">Faqs</span>
				</a>
				<ul>
					<li><a href="{{ url('admin/faq/index') }}">List Faqs</a></li>
					<li><a href="{{ url('admin/faq/add') }}">Add New Faq</a></li>
				</ul>
			</li>
            <li class="menu-title">Messages Section</li>
			<li>
				<a href="{{ route('admin.contactmessages') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-email"></i></span>
					<span class="s-text">Contact Messages</span>
				</a>
			</li>
			<li>
				<!--<a href="{{ route('admin.sendmessage') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-email"></i></span>
					<span class="s-text">Send Messages</span>
				</a>-->
                <a href="{{ route('admin.sendmessages') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-email"></i></span>
					<span class="s-text">Send Messages</span>
				</a>
			</li>
            <li class="menu-title">Information Pages</li>
			<li>
            ...
            <li>
				<a href="{{ route('admin.aboutus') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="ti-book"></i></span>
					<span class="s-text">About Us App</span>
				</a>
			</li>
            <!--<li>
				<a href="{{ route('admin.support') }}" class="waves-effect waves-light">
