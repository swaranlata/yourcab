...
<script>
    ...
    function initMap() {
        ...
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['offline'] + '"> ' + 'Unavailable Driver';
        legend.appendChild(div);
        ...
        var div = document.createElement('div');
        div.innerHTML = '<img src="' + mapIcons['unactivated'] + '"> ' + 'Unactivated Driver';
        legend.appendChild(div);
    ...
    function addMarkerToMap(element, index) {
        ...
        google.maps.event.addListener(marker, 'click', function() {
            window.location.href = APP_URL+'/admin/' + element.service ? 'provider' : 'user' + '/' +element.user_id;
        });
    }
</script>
